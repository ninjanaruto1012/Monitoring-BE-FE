...
export class AppComponent{
  ...
  msgList: any[] = [];
  msgList2: any[] = [];
  serverUrl = (environment as any).wsUrl;
  ...
  initializeWebSocketConnection(){
    ...
    this.stompClient.connect({}, function() {
      that.stompClient.subscribe("/monitor/abc", (message: any) => {
          ...
          let mse: any = Number(newValue.Mse);
          ...
          that.chart5 = Highcharts.chart('chart-line-5', {
            chart: {
              type: 'spline',
              zoomType: 'xy'
            },
            ...
            title: {
              text: 'Average Mean Square Error (MSE) between actual and predicted value ',
            },
            credits: {
              enabled: false,
            },
          ...
          that.chart5.series[0].setData(data9);
          ...
          that.chart5.series[0].data[0].remove();
